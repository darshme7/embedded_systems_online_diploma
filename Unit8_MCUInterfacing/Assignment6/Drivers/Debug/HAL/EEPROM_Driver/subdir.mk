...
HAL/EEPROM_Driver/%.o HAL/EEPROM_Driver/%.su: ../HAL/EEPROM_Driver/%.c HAL/EEPROM_Driver/subdir.mk
...
clean: clean-HAL-2f-EEPROM_Driver

clean-HAL-2f-EEPROM_Driver:
	-$(RM) ./HAL/EEPROM_Driver/EEPROM.d ./HAL/EEPROM_Driver/EEPROM.o ./HAL/EEPROM_Driver/EEPROM.su

.PHONY: clean-HAL-2f-EEPROM_Driver

...
#ifndef INC_ATMEGA32_USART_DRIVER_H_
#define INC_ATMEGA32_USART_DRIVER_H_
...
typedef struct{
	...
	uint8 USART_InterruptEnable;		//specifies whether to enable interrupt or not
										//must be a value of @ref USART_INTERRUPT_ENABLE_define
...
//@ref USART_INTERRUPT_ENABLE_define

#define USART_INTERRUPT_DISABLE				0
#define USART_INTERRUPT_TXCIE				1
#define USART_INTERRUPT_RXCIE				2
#define USART_INTERRUPT_TXCIE_RXCIE			3
